...
const config: DocsThemeConfig = {
    logo: <span>Guance CLI</span>,
    head: (
        <>
            <meta name="viewport" content="width=device-width, initial-scale=1.0" />
            <meta property="og:title" content="Guance CLI" />
            <meta property="og:description" content="Your toolkit for Guance Cloud control-plane" />
            <meta name="apple-mobile-web-app-title" content="Guance CLI" />
